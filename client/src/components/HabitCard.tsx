...
export const HabitCard: React.FC<HabitCardProps> = ({
  ...
  return (
    <div
      className={`group rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 border flex flex-col relative
      ${
        isCompletedToday
    ...
    >
      ...
      <div className="flex gap-3 mb-4 pr-16">
        <div
          className={`h-10 w-10 shrink-0 rounded-xl flex items-center justify-center text-xl transition-colors
          ${
            isCompletedToday
        ...
        >
          {isCompletedToday ? (
            ...
            <img src={category.icon_url} alt="" className="h-6 w-6" />
          ) : (
        ...
        <div>
          <h3
            className={`font-bold text-lg leading-tight ${isCompletedToday ? "text-green-900 dark:text-green-100" : "text-gray-900 dark:text-white"}`}
          >
            {habit.name}
          </h3>
      ...
      {/* Footer */}
      <div
        className={`mt-auto pt-4 border-t ${isCompletedToday ? "border-green-100 dark:border-green-900/30" : "border-gray-50 dark:border-gray-700"}`}
      >
        {!isCompletedToday ? (
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="text-right">
              <p className="text-xs text-green-600/70 dark:text-green-400/70 font-bold uppercase tracking-wider">
                Streak
              </p>
